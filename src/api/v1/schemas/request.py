...
class PodcastProcessRequest(BaseModel):
    url: str = Field(..., description="Podcast URL (Apple / Xiaoyuzhou / YouTube / RSS / direct audio)")
    episode_index: int | None = Field(None, description="For RSS feeds: which episode (0=latest)")
    language_hint: str | None = Field(None, description="Optional language hint, e.g. 'zh', 'en'")
